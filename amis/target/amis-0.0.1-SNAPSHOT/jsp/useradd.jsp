...
<h4 class="text-center mt-5" style="color: red;"><%=ServletUtility.getErrorMessage(request)%></h4>
	<h4 class="text-center mt-5" style="color: green;"><%=ServletUtility.getSuccessMessage(request)%></h4>
		...
		<div class="container mt-5">
		  <div class="row h-100 justify-content-center align-items-center">
		...
		</label> <input type="text" name="item" class="form-control "
			...
			<div class="col-6">
				<label for="exampleInputEmail1" class="form-label">Userid</label> <input
			...
			<div class="col-6">
				<label for="exampleInputEmail1" class="form-label">Status</label> <input
