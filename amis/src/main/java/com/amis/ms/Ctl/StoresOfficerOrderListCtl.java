 ...
 */
@WebServlet(name = "StoresOfficerOrderListCtl", urlPatterns = "/storesofficerorderlist")
public class StoresOfficerOrderListCtl extends BaseCtl {
	private static final long serialVersionUID = 1L;
       
  
    public StoresOfficerOrderListCtl() {
        super();
    }
	...
	protected String getView() {
		return AMView.STORESOFFICER_ORDER_LIST_VIEW;
	}
