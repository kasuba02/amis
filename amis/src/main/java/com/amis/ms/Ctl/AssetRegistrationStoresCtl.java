 ...
 */
@WebServlet(name = "AssetRegistrationStoresCtl", urlPatterns = "/assetregistrationstores")
public class AssetRegistrationStoresCtl extends BaseCtl {
     ...
     */
    public AssetRegistrationStoresCtl() {
        super();
	...
	protected String getView() {
		return AMView.ASSET_REGISTRATION_STORES_VIEW;
	}
