 ...
 */
@WebServlet(name = "AssetRegistrationCtl", urlPatterns = "/assetregistration")
public class AssetRegistrationCtl extends BaseCtl {
	...
	protected String getView() {
		return AMView.ASSET_REGISTRATION_VIEW;
	}
